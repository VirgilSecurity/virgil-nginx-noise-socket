...
#define NGX_NSOC_2MSG 1
#define NGX_NSOC_3MSG 2
#define NGX_NSOC_2MSG_ERR 3
#define NGX_NSOC_1MSG_NEG_DATA_SIZE 6
#define NGX_NSOC_2MSG_NEG_DATA_SIZE 3
#define NGX_NSOC_3MSG_NEG_DATA_SIZE 2
#define NGX_NSOC_2MSG_NEG_ERR_SIZE 3
